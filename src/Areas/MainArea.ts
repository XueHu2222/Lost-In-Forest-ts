...
export default class MainArea extends Area {
  ...
  public override render(): void {
    ...
    CanvasRenderer.writeText(LostInTheForest.canvas, 'Help waar ben ik?', LostInTheForest.canvas.width * 0.48, LostInTheForest.canvas.height * 0.36, 'left', 'Arial', 25, 'black');
    CanvasRenderer.writeText(LostInTheForest.canvas, 'Ik wil terug naar huis!', LostInTheForest.canvas.width * 0.48, LostInTheForest.canvas.height * 0.43, 'left', 'Arial', 25, 'black');
