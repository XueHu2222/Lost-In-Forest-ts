...
export default class Button extends CanvasItem {
  ...
  public constructor(text: string | null, posX: number, posY: number, image: HTMLImageElement | null = null) {
    super();
    this.text = text;
    this.posX = posX;
    this.posY = posY;
  ...
  */
  public override render(canvas: HTMLCanvasElement): void {
    super.render(canvas); // makes sure it always renders the parent class (canvasItem)
    if (this.text) {
